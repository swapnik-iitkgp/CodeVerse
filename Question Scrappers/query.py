...
def load_vocab():
    vocab = {}
    with open('tf-idf/cf_vocab.txt', 'r') as f:
        vocab_terms = f.readlines()
    with open('tf-idf/cf_idf-values.txt', 'r') as f:
...
def load_documents():
    documents = []
    with open('tf-idf/cf_documents.txt', 'r') as f:
...
def load_inverted_index():
    inverted_index = {}
    with open('tf-idf/cf_inverted-index.txt', 'r') as f:
