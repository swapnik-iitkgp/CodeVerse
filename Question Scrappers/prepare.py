...
filename = 'Codeforces-Questions-Scrapper/Codeforces-Questions-Scrapper-data/index.txt'
...
with open('tf-idf/cf_vocab.txt', 'w') as f:
    for key in vocab.keys():
        f.write("%s\n" % key)

# save the idf values in a text file
with open('tf-idf/cf_idf-values.txt', 'w') as f:
    for key in vocab.keys():
        f.write("%s\n" % vocab[key])

# save the documents in a text file
with open('tf-idf/cf_documents.txt', 'w') as f:
...
with open('tf-idf/cf_inverted-index.txt', 'w') as f:
